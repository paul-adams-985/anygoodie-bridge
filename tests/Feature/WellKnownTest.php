...
describe('assetlinks.json', function () {
    ...
    it('filters null fingerprints and reindexes', function () {
        config([
    ...
    it('includes both fingerprints when both set', function () {
        config([
...
describe('apple-app-site-association', function () {
    ...
    it('contains wildcard path component allowing all routes', function () {
        $response = $this->getJson('/.well-known/apple-app-site-association');
